...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        public void Run()
        {
            ...
            {
                conn.ConnectionString = @"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Suha\Documents\GitHub\Arbetsprov\WebApplication1\App_Data\Database1.mdf;Integrated Security=True;User Instance=True";
                conn.Open();
                try
                {
